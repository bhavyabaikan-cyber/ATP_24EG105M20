...
function EditEmployee() {
  ...
  return (
    <div>
        <h1 className='text-5xl text-center text-blue-300-900'>Edit Employee</h1>
        {/* form */}
        ...
        <button type = "submit" className = "text-2xl rounded-2xl bg-grey-200 text-pink-900 block mx-auto p-3">Save</button>
